...
<head>
    ...
    {{-- Memuat dari dalam folder 'css' --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('css/vendor.css') }}" />

    {{-- Memuat langsung dari folder 'public' --}}
...
<body>
    ...
    <div class="offcanvas offcanvas-end fade" data-bs-scroll="true" tabindex="-1" id="offcanvasCart">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title mx-auto">Keranjang Belanja</h5>
        ...
        <div class="offcanvas-body py-4">
            <div class="order-md-last">
                <h5 class="d-flex justify-content-between align-items-center mb-4">
                    <span class="text-primary">Isi Keranjang</span>
                ...
                <ul class="list-group mb-4 shadow-sm">
                    <li class="list-group-item d-flex justify-content-between lh-sm py-3">
                        <div>
                            <h6 class="my-0 text-capitalize">Jaket Kulit Klasik</h6>
                            <small class="text-muted">Dijual oleh <strong>SellerVintageID</strong></small>
                        </div>
                        <span class="text-muted">Rp250.000</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-sm py-3">
                        <div>
                            <h6 class="my-0 text-capitalize">Kemeja Flanel 90an</h6>
                            <small class="text-muted">Dijual oleh <strong>ThriftCool</strong></small>
                        </div>
                        <span class="text-muted">Rp85.000</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-sm py-3">
                        <div>
                            <h6 class="my-0 text-capitalize">Tas Selempang Kanvas</h6>
                            <small class="text-muted">Dijual oleh <strong>SellerVintageID</strong></small>
                        </div>
                        <span class="text-muted">Rp120.000</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between border-top pt-3">
                        <strong>Total</strong>
                        <strong>Rp455.000</strong>
                    </li>
                </ul>
    ...
    <header class="p-3 mb-2 mt-2 sticky-top bg-white shadow-sm z-3">
        <div class="container-fluid">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <!-- Logo -->
                <a href="index.html" class="d-flex align-items-center text-dark text-decoration-none me-3">
                ...
                <ul class="nav justify-content-center flex-grow-1">
                    <li class="nav-item">
                        <a href="#beranda" class="nav-link px-3 text-dark active text-uppercase">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a href="#new-arrivals" class="nav-link px-3 text-dark text-uppercase">Baru Tiba</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark text-uppercase px-3" href="#"
                            id="pagesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Halaman
                        </a>
                        <ul class="dropdown-menu border-0 shadow" aria-labelledby="pagesDropdown">
                            <li><a href="#kategori" class="dropdown-item">Kategori</a></li>
                            <li>
                                <a href="#harta-karun" class="dropdown-item">Harta Karun</a>
                            </li>
                            <li>
                                <a href="#membership" class="dropdown-item">Membership</a>
                            </li>
                            <li>
                                <a href="#produk-populer" class="dropdown-item">Produk Populer</a>
                            </li>
                            <li>
                                <a href="#testimoni" class="dropdown-item">Testimoni</a>
                            </li>
                            <li>
                                <a href="#tips-trik" class="dropdown-item">Tips & Trik</a>
                            </li>
                            <li>
                                <a href="#akun" class="dropdown-item">Akun Saya</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="d-flex align-items-center ms-3">
                    <!-- Form Pencarian -->
                    <form class="me-3 d-flex" role="search">
                        <div class="input-group">
                            <select class="form-select d-none d-lg-block" style="max-width: 120px">
                    ...
                    <div class="dropdown position-relative">
                        ...
                        <a href="#" class="text-dark me-3" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false" title="Akun">
                        ...
                        <!-- Isi dropdown -->
                        <ul class="dropdown-menu dropdown-menu-start shadow rounded-3" data-bs-popper="static">
                            <li>
                                <div class="dropdown-item d-flex align-items-center gap-2 py-2">
                                    ...
                                    <div>
                                        <a href="{{ route('login') }}" class="text-reset text-decoration-none">Masuk</a>
                                        <span class="text-body-secondary mx-1">/</span>
                                        <a href="{{ route('register') }}" class="text-reset text-decoration-none">Daftar</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="#">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        fill="currentColor" viewBox="0 0 16 16">
                                        <path
                                            d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L8 2.131l3.75 1.33L14.154 3.5zM15 4.239l-6.5 2.6v7.922l6.5-3.25V4.24zM1 4.239v7.25l6.5 3.25V6.839L1 4.24zM8 5.732L1.5 3.132l6.5-2.6 6.5 2.6z" />
                                    </svg>
                                    Pesanan
                                </a>
                            </li>
                    ...
                    <a href="#" class="text-dark me-3" title="Favorit">
                    ...
                    <a href="#" class="text-dark" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                        title="Keranjang">
      ...
      ">
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-5 py-5 my-5">
                    ...
                    <p class="fs-5">
                        ...
                        vintage, dan langka dari para penjual di seluruh Indonesia.
                    </p>
                    <div class="d-flex gap-3">
                        <a href="#" class="btn btn-dark text-uppercase fs-6 rounded-pill px-5 py-4 mt-3">Mulai
                            Belanja</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-0 justify-content-center shadow">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="card-body p-0">
                                    <h5>Pilihan Unik</h5>
                                    <p class="card-text">
                                        Temukan item fashion satu-satunya dari berbagai era dan
                                        gaya.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col">
                    <div
                        class="card border-0 border-light-subtle border-start border-end bg-white rounded-0 p-5 text-dark">
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <svg width="60" height="60">
                                    <use xlink:href="#hand-stars"></use>
                                </svg>
                            </div>
                            <div class="col-md-9">
                                <div class="card-body p-0">
                                    <h5>Komunitas Terpercaya</h5>
                                    <p class="card-text">
                                        Bergabung dengan ribuan thrifter dan penjual
                                        terverifikasi.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="card-body p-0">
                                    ...
                                    <p class="card-text">
                                        Nikmati jaminan uang kembali dan sistem transaksi yang
                                        aman.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                ...
                                <h4 class="fs-6 mt-3 fw-normal category-title">Hoodie</h4>
                            </a>

                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="images/category-thumb-2.jpg" class="img-fluid" alt="Thumbnail Kategori" />
                                <h4 class="fs-6 mt-3 fw-normal category-title">T-shirt</h4>
                            </a>

                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="images/category-thumb-3.jpg" class="img-fluid" alt="Thumbnail Kategori" />
                                <h4 class="fs-6 mt-3 fw-normal category-title">Jeans</h4>
                            </a>

                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="images/category-thumb-4.jpg" class="img-fluid" alt="Thumbnail Kategori" />
                                <h4 class="fs-6 mt-3 fw-normal category-title">Sweater</h4>
                            </a>
    ...
    <section id="new-arrivals" class="section-padding pt-0">
        <div class="container-lg">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-header d-flex flex-wrap justify-content-between mb-3">
                        <h2 class="section-title text-capitalize">Baru Tiba</h2>
                        <div class="d-flex align-items-center">
                            <a href="#" class="btn btn-primary rounded-1" id="lihatSemuaProduk">Lihat Semua</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="product-grid row row-cols-1  row-cols-sm-2 row-cols-md-3 row-cols-lg-4 gx-3 gy-5">
                        {{-- AWAL PERULANGAN PRODUK DINAMIS --}}
                        @forelse ($products as $product)
                            <div class="col" data-kategori="thrifting"> {{-- data-kategori bisa dibuat dinamis nanti --}}
                                <div class="product-item mb-4">

                                    {{-- Anda bisa menambahkan logika untuk badge di sini nanti --}}
                                    {{-- <span class="badge bg-success position-absolute top-0 start-0 m-2" style="z-index: 1">Kondisi: Like New</span> --}}
                                    ...
                                    <figure>
                                        <a href="#" title="{{ $product->name }}">
                                            ...
                                            @else
                                                ...
                                                <img src="{{ asset('images/product-thumb-placeholder.jpg') }}"
                        ...
                        @empty
                            {{-- Pesan ini akan tampil jika tidak ada produk sama sekali di database --}}
                            <div class="col-12">
                                <p class="text-center text-muted">Belum ada produk yang bisa ditampilkan saat ini.</p>
                            </div>
                        @endforelse
                        {{-- AKHIR PERULANGAN PRODUK DINAMIS --}}
            ...
            <div class="row">
                ...
                ">
                            <div class="banner-content p-5">
                                <div class="content-wrapper text-light">
                                    <h3 class="banner-title text-light">
                                        Koleksi Pilihan Editor
                                    </h3>
                                    <p>Pilihan terbaik dari kurator kami.</p>
                                    <a href="#" class="btn-link text-white">Lihat Koleksi</a>
                                </div>
                            </div>
                        </div>
                ...
                ">
                            <div class="banner-content align-items-center p-5">
                                <div class="content-wrapper text-light">
                                    <h3 class="banner-title text-light">Gaya OOTD Hemat</h3>
                                    <p>Dapatkan setelan lengkap dengan harga spesial.</p>
                                    <a href="#" class="btn-link text-white">Belanja Sekarang</a>
                                </div>
                            </div>
                        </div>
                ...
                ">
                            <div class="banner-content align-items-center p-5">
                                <div class="content-wrapper text-light">
                                    <h3 class="banner-title text-light">Clearance Sale</h3>
                                    <p>Stok terbatas! Dapatkan harga terbaik.</p>
                                    <a href="#" class="btn-link text-white">Cek Promo</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="harta-karun" class="pt-0 products-carousel">
        <div class="container-lg overflow-hidden py-1">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="swiper">
                        <div class="swiper-wrapper">
                            <div class="product-item swiper-slide mb-5">
                                <span class="badge bg-success position-absolute top-0 start-0 m-2"
                                    style="z-index: 1">Kondisi: Like
                                    New</span>

                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-9.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                                    <h3 class="fs-6 fw-normal">Nama Produk</h3>
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <del>Rp240.000</del>
                                        <span class="text-dark fw-semibold">Rp180.000</span>
                                        <span
                            ...
                            <div class="product-item swiper-slide mb-4">
                                ...
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-10.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                ...
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-11.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                ...
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-12.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                ...
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-13.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                ...
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-14.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-5 p-5">
                            <div class="section-header">
                                <h2 class="section-title text-capitalize display-5 text-light">
                                    Dapatkan Info Koleksi Terbaru & Diskon Spesial
                                </h2>
                            </div>
                            <p>
                                Jadilah yang pertama tahu tentang harta karun terbaru yang
                                masuk ke marketplace kami.
                            </p>
                        </div>
    ...
    <section id="produk-populer" class="section-padding products-carousel">
        <div class="container-lg overflow-hidden py-3">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-header d-flex flex-wrap justify-content-between my-4">
                        <h2 class="section-title text-capitalize">Produk populer</h2>
                    ...
                    <div class="swiper">
                        <div class="swiper-wrapper">
                            <div class="product-item swiper-slide mb-4">
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-15.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-16.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-17.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-18.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                            ...
                            <div class="product-item swiper-slide mb-4">
                                <figure>
                                    <a href="single-product.html" title="Product Title">
                                        <img src="images/product-thumb-19.jpg" alt="Product Thumbnail"
                                            class="img-fluid" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
    ...
    <section id="testimoni" class="section-padding pt-0">
        <div class="container-lg">
            <div class="swiper testimonial-Swiper text-center">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Dapet jaket vintage idaman di sini! Kondisinya masih bagus
                            banget, sellernya juga ramah. Mantap!"
                        </p>
                        <span class="fw-bold mt-3">C.RONALDO</span>
                    </div>

                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Awalnya ragu beli baju bekas online, tapi di sini transaksinya
                            aman dan barangnya sesuai deskripsi. Recommended!"
                        </p>
                        <span class="fw-bold mt-3">B.FERNANDES</span>
                    </div>

                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Suka banget sama konsepnya, bisa nemu banyak item unik yang gak
                            ada di toko biasa. Jadi ketagihan berburu!"
                        </p>
                    ...
                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Diskon dan promo yang diberikan sangat menarik. Saya pasti akan
                            berbelanja lagi!"
                        </p>
                        <span class="fw-bold mt-3">M.SALLAH</span>
                    </div>
                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Belanja di sini selalu bikin puas! Barangnya original, harga masuk akal,
                            pengiriman juga cepat banget. Recommended store!"
                        </p>
                        <span class="fw-bold mt-3">V.VAN DIJK</span>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <p class="review fw-light fs-4">
                            "Pelayanan ramah, respon cepat, dan pilihan produk banyak banget.
                            Cocok buat yang suka koleksi vintage!"
                        </p>
                        <span class="fw-bold mt-3">N.MARTINEZ</span>
                    </div>
    ...
    <section id="tips-trik" class="section-padding pt-0">
        <div class="container-lg">
            <div class="row">
                <div class="section-header d-flex align-items-center justify-content-between my-4">
                    <h2 class="section-title text-capitalize">Tips & Trik Thrifting</h2>
                    <a href="#" class="btn btn-primary" id="lihatSemuaTips">Lihat Semua</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                <div class="meta-date"><a href="#"
                                        class="text-secondary text-decoration-none">29 Juni 2025</a></div>
                                <div class="meta-categories"><a href="#"
                                        class="text-secondary text-decoration-none">tips & trik</a>
                                </div>
                            </div>
    ...
    <p>Pakaian vintage butuh perawatan khusus. Ikuti tips ini agar koleksi berhargamu tetap
        ...
        prima.</p>
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                <div class="meta-date"><a href="#"
                                        class="text-secondary text-decoration-none">28 Juni 2025</a></div>
                                <div class="meta-categories"><a href="#"
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        ...
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                <div class="meta-date"><a href="#"
                                        class="text-secondary text-decoration-none">27 Juni 2025</a></div>
                                <div class="meta-categories"><a href="#"
                                        class="text-secondary text-decoration-none">Inspirasi Gaya</a>
                                </div>
                            </div>
                            <div class="post-header">
            ...
            <div class="row" id="artikelTambahanWrapper">
                <div class="col-md-4">
                    <article class="post-item card border-0 rounded-0">
                        <div class="image-holder zoom-effect">
                        ...
                        <div class="card-body px-0">
                            <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                                <div class="meta-date"><a href="#"
                                        class="text-secondary text-decoration-none">26 Juni 2025</a></div>
                                <div class="meta-categories"><a href="#"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        {{-- Ganti src ini dengan path logo Anda yang benar menggunakan asset() --}}
                        <img src="{{ asset('images/logo.svg') }}" width="300" height="190"
                            alt="logo" />
...
<li class="menu-item"><a href="{{ url('/blog') }}" class="nav-link">Blog</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title text-light">Berlangganan</h5>
                        <p>Dapatkan info koleksi terbaru dan penawaran spesial langsung di email Anda.</p>
                        <form class="d-flex mt-3 gap-0">
                            <input class="form-control rounded-start rounded-0 bg-light" type="email"
                                placeholder="Alamat Email" aria-label="Alamat Email" />
                            <button class="btn btn-primary rounded-end rounded-0" type="submit">Langganan</button>
                        </form>
                    </div>
                </div>
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>© 2025 Shutthegoods. Hak cipta dilindungi undang-undang.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="mt-3">Halo, C.RONALDO!</h4>
                        <p class="text-muted">Selamat datang kembali di Shutthegoods</p>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var testimonialSwiper = new Swiper(".testimonial-Swiper", {
                // Aktifkan mode loop agar bisa berputar terus-menerus
                loop: true,

                // Atur pagination (titik-titik di bawah)
                pagination: {
                    el: ".testimonial-pagination",
                    clickable: true, // Membuat titik pagination bisa di-klik
                },

                // Mengizinkan geser/drag dengan mouse di desktop
                mousewheel: false, // Anda bisa set ke true jika ingin scroll dengan mousewheel
                keyboard: true, // Mengizinkan navigasi dengan keyboard

                // Opsi agar bisa digeser dengan jari (touch) dan mouse (drag)
                grabCursor: true, // Menampilkan kursor tangan saat hover

                // Set slide yang akan ditampilkan per tampilan
                slidesPerView: 1,
                spaceBetween: 30, // Jarak antar slide (jika ada lebih dari 1 slide terlihat)
            });
        });
    </script>
</body>
